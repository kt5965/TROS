...
$(SRC_DIR)/main.o: $(SRC_DIR)/main.c
		$(CC) -m32 -ffreestanding $(SRC_DIR)/main.c -o $(SRC_DIR)/main.o
...
bin/test.img: $(BIN_DIR)/boot1.bin $(BIN_DIR)/kernel1.bin $(BIN_DIR)/disk.img
		cat $(BIN_DIR)/boot1.bin $(BIN_DIR)/kernel1.bin $(BIN_DIR)/disk.img > $(BIN_DIR)/test.img

# clean
clean:
		rm -f $(BIN_DIR)/boot1.bin $(BIN_DIR)/kernel1.bin $(SRC_DIR)/main.o $(BIN_DIR)/main.img $(BIN_DIR)/disk.img $(BIN_DIR)/test.img
